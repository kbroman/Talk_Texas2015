...
d3.json("Data/corr_w_scatter.json", function(data) {
  var cells, colorScale, colors, corXscale, corYscale, corZscale, corr, corrplot, drawScatter, extraPad, firsttime, h, i, innerPad, j, nGroup, nind, nvar, pad, scatcolors, scatterplot, svg, totalh, totalw, w;
  h = 450;
  w = h;
  pad = {
    left: 70,
